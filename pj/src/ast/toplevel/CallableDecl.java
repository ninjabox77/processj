...
public abstract class CallableDecl<T extends CallableDecl<?>> extends TopLevelDeclaration<T> {
  ...
  public CallableDecl(int modifiers, ASTType type, final String name, Sequence<ConstructedNode> implementedNames) {
    this(modifiers, type, name, implementedNames, new BlockStmt());
  }

  public CallableDecl(int modifiers, ASTType type, final String name, Sequence<ConstructedNode> implementedNames, BlockStmt body) {
    this(null, modifiers, type, name, implementedNames, null, body);
  }

  public CallableDecl(Token token, int modifiers, ASTType type, final String name, Sequence<ConstructedNode> implementedNames, Sequence<Parameter> parameters, BlockStmt body) {

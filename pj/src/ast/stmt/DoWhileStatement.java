 ...
 * @author Ben
 */
public class DoWhileStatement extends Statement implements LoopingStmt<DoWhileStatement> {
  ...
  public DoWhileStatement(BooleanExpression condition, Statement loopBlock) {
    this(null, condition, loopBlock);
  }

  public DoWhileStatement(Token token, BooleanExpression condition, Statement loopBlock) {
    super(token, null);
    setCondition(condition);
    setLoopBlock(loopBlock);
  }

  public DoWhileStatement setCondition(BooleanExpression condition) {
  ...
  @Override
  public DoWhileStatement setLoopBlock(Statement loopBlock) {

...
public class ConstructorDeclaration extends MethodDeclaration<ConstructorDeclaration> {
  ...
  public ConstructorDeclaration(final int modifiers, NodeType type, final String name) {
    this(modifiers, type, name, new BlockStatement());
  }

  public ConstructorDeclaration(final int modifiers, NodeType type, final String name, BlockStatement body) {
    this(null, modifiers, type, name, null, body);
  }

  public ConstructorDeclaration(Token token, final int modifiers, NodeType type, final String name, Sequence<Parameter> parameters, BlockStatement body) {

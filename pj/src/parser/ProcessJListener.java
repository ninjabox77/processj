...
public interface ProcessJListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link ProcessJParser#caseExpression}.
   *
   * @param ctx the parse tree
   */
  void enterCaseExpression(ProcessJParser.CaseExpressionContext ctx);

  /**
   * Exit a parse tree produced by {@link ProcessJParser#caseExpression}.
   *
   * @param ctx the parse tree
   */
  void exitCaseExpression(ProcessJParser.CaseExpressionContext ctx);

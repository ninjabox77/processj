...
public enum PJBugManager {
    ...
    public void printTrace(String src) {
        ...
        System.out.println("| (" + errCount + " post panic error messages)");
        System.out.println("| (" + warnCount + " post warning messages)");
        System.out.println("| (" + infoCount + " post info messages)");
        System.out.println("...");

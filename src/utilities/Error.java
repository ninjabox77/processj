...
//        System.out.println(fileName + ":" + e.line + ": " + msg);
        System.out.println(PJBugManager.INSTANCE.fileName + ":" + e.line + ": " + msg);
        System.exit(1);
    }

    public static void error(String msg) {
//        System.out.println(fileName + ": " + msg);
        System.out.println(PJBugManager.INSTANCE.fileName + ": " + msg);
        System.exit(1);
    }
...
//        System.out.print(fileName + ":" + e.line + ": " + msg);
        ...
        if (terminate)
            ...
            errorCount++;
//            errors += "\n" + fileName + ":" + e.line + ": " + msg;
            errors += "\n" + PJBugManager.INSTANCE.fileName + ":" + e.line + ": " + msg;

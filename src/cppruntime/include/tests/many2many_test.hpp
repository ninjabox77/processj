#ifndef MANY2MANY_TEST_HPP
#define MANY2MANY_TEST_HPP

namespace pj_tests
{
    template <typename T>
    class many2many_writer : public pj_runtime::pj_process
    {
    public:
        many2many_writer() = delete;

        many2many_writer(int32_t                              id,
                       pj_runtime::pj_many2many_channel<T>* chan,
                       T                                    data)
        {
            this->id = id;
            this->chan = chan;
    ...
    private:
        ...
        pj_runtime::pj_many2many_channel<T>* chan = nullptr;
    };

    template <typename T>
    class many2many_reader : public pj_runtime::pj_process
    {
    public:
    ...
    public:
        ...
        void run()
        {
            ...
            pj_runtime::pj_many2many_channel<int32_t> mtm_ch;
            ...
            std::vector<pj_runtime::pj_process*> processes(8);

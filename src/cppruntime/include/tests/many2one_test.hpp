#ifndef MANY2ONE_TEST_HPP
#define MANY2ONE_TEST_HPP

namespace pj_tests
{
	template <typename T>
    class many2one_writer : public pj_runtime::pj_process
    {
    public:
        many2one_writer() = delete;

        many2one_writer(int32_t                              id,
                       pj_runtime::pj_many2one_channel<T>* chan,
                       T                                   data)
        : id(id), data(data)
        {
            this->chan = chan;
    ...
    template <typename T>
    class many2one_reader : public pj_runtime::pj_process
    {
    public:
    ...
    public:
        ...
        void run()
        {
            ...
            pj_runtime::pj_many2one_channel<int32_t> mto_ch;

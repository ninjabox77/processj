...
{
    template <typename T>
    class one2one_multi_writer : public pj_runtime::pj_process
    {
    public:
        one2one_multi_writer() = delete;

        one2one_multi_writer(int32_t                              id,
        ...
        virtual ~one2one_multi_writer() = default;
    ...
    template <typename T>
    class one2one_multi_reader : public pj_runtime::pj_process
    {
    public:
        one2one_multi_reader() = delete;

        one2one_multi_reader(int32_t                              id,
                             pj_runtime::pj_one2one_channel<T>* chan)
        : id(id)
        {
            this->chan = chan;
        ...
        virtual ~one2one_multi_reader() = default;
    ...
    public:
        ...
        void run()
        {
            ...
            one2one_multi_reader<int32_t>* oto_r = new one2one_multi_reader<int32_t>(0, &oto_ch);

            one2one_multi_writer<int32_t>* oto_w = new one2one_multi_writer<int32_t>(1,
                                                                                     &oto_ch,
                                                                                     69);

#ifndef ONE2MANY_TEST_HPP
#define ONE2MANY_TEST_HPP

namespace pj_tests
{
	template <typename T>
    class one2many_writer : public pj_runtime::pj_process
    {
    public:
        one2many_writer() = delete;

        one2many_writer(int32_t                              id,
                       pj_runtime::pj_one2many_channel<T>* chan,
                       T                                   data,
                       uint32_t                         readers)
    ...
    template <typename T>
    class one2many_reader : public pj_runtime::pj_process
    {
    public:
    ...
    public:
        ...
        void run()
        {
            ...
            pj_runtime::pj_one2many_channel<int32_t> otm_ch;
            ...
            std::vector<pj_runtime::pj_process*> processes(4);
            for(i = 0; i < 3; ++i)
            {
